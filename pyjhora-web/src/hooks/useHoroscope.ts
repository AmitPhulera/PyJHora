...
// They must NOT maintain a separate SwissEph instance calling the swisseph-wasm
// `swe.calc_ut()` JS wrapper directly — that wrapper intermittently returns
// zeroed/garbage longitudes (e.g. Venus -> Pisces); the adapter avoids it via a
// direct `ccall('swe_calc_ut', ...)`. See ui-ephemeris-duplicate-path memory.
// ============================================================================
