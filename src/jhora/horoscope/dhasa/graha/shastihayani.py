...
# @parity: ts=@/core/dhasa/graha/shastihayani::getNextShastihayaniLord
...
# @parity: ts=@/core/dhasa/graha/shastihayani::getShastihayaniDhasaLord
...
def _antardhasa(dhasa_lord,antardhasa_option=1):
    ...
    return _bhukthis
# @parity: ts=@/core/dhasa/graha/shastihayani::shastihayaniDashaStart
